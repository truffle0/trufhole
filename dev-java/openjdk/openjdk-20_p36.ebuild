...
# I was so confused with the package versioning while updating the ebuild from openjdk 17.
# Turns out openjdk simplified the versioning, for say 17.0.5_p10 to just 20_p36.
# -truffle
...
S="${WORKDIR}/jdk${SLOT}u-jdk-${MY_PV//+/-}-36"
