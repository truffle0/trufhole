...
IUSE="+asm cpu_flags_x86_sse2 fips ktls rfc3779 rootprefix sctp static-libs test tls-compression vanilla verify-sig"
RESTRICT="!test? ( test )"
...
multilib_src_configure() {
	...
	local myeconfargs=(
		...
		$(if use rootprefix ; then echo '--prefix="${EPREFIX}/"' ; else '--prefix="${EPREFIX}"/usr')
